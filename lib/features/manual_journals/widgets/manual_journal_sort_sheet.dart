...
class ManualJournalSortSheet extends StatefulWidget {
  ...
  @override
  State<ManualJournalSortSheet> createState() => _ManualJournalSortSheetState();
}

class _ManualJournalSortSheetState extends State<ManualJournalSortSheet> {
  late ManualJournalSortField _sortField;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            for (final field in ManualJournalSortField.values)
              InkWell(
