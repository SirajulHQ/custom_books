...
import 'package:custom_books/features/projects/view/add_project_page.dart';
import 'package:custom_books/features/projects/view/project_details_page.dart';
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        headerSliverBuilder: (context, _) => [
          CustomSliverAppBar(
            title: 'Projects',
            subtitle: '${_projects.length} project${_projects.length == 1 ? '' : 's'}',
