...
class CreditNotesSettingsPage extends StatefulWidget {
  const CreditNotesSettingsPage({super.key});

  @override
  State<CreditNotesSettingsPage> createState() =>
      _CreditNotesSettingsPageState();
}

class _CreditNotesSettingsPageState extends State<CreditNotesSettingsPage>
  ...
  void initState() {
    ...
    appLog(
      '📋 CreditNotesSettingsPage initialized',
      name: 'CreditNotesSettings',
    );
  }
  ...
  void _save() {
    appLog('💾 Save Credit Notes Settings', name: 'CreditNotesSettings');
    _committedFields
      ..clear()
