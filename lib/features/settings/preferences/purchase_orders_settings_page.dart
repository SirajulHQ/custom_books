...
class PurchaseOrdersSettingsPage extends StatefulWidget {
  const PurchaseOrdersSettingsPage({super.key});

  @override
  State<PurchaseOrdersSettingsPage> createState() =>
      _PurchaseOrdersSettingsPageState();
}

class _PurchaseOrdersSettingsPageState extends State<PurchaseOrdersSettingsPage>
  ...
  void initState() {
    ...
    appLog(
      '📋 PurchaseOrdersSettingsPage initialized',
      name: 'PurchaseOrdersSettings',
    );
  }
  ...
  void _save() {
    appLog('💾 Save Purchase Orders Settings', name: 'PurchaseOrdersSettings');
    _committedFields
      ..clear()
