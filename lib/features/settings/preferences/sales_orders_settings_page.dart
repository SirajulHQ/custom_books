...
class SalesOrdersSettingsPage extends StatefulWidget {
  const SalesOrdersSettingsPage({super.key});

  @override
  State<SalesOrdersSettingsPage> createState() =>
      _SalesOrdersSettingsPageState();
}

class _SalesOrdersSettingsPageState extends State<SalesOrdersSettingsPage>
  ...
  void initState() {
    ...
    appLog(
      '📦 SalesOrdersSettingsPage initialized',
      name: 'SalesOrdersSettings',
    );
  }
  ...
  void _save() {
    appLog('💾 Save Sales Orders Settings', name: 'SalesOrdersSettings');
    _committedFields
      ..clear()
