...
class ExpenseSortSheet extends StatefulWidget {
  ...
  @override
  State<ExpenseSortSheet> createState() => _ExpenseSortSheetState();
}

class _ExpenseSortSheetState extends State<ExpenseSortSheet> {
  late ExpenseSortField _sortField;
