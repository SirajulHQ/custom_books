...
class RecurringInvoicesMoreOptionsSheet extends StatelessWidget {
  final VoidCallback onExport;
  final VoidCallback onRefresh;
  final VoidCallback onClose;

  const RecurringInvoicesMoreOptionsSheet({
    super.key,
  ...
  static void show(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => RecurringInvoicesMoreOptionsSheet(
