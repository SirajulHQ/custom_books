...
class PaymentReceivedSortSheet extends StatefulWidget {
  ...
  @override
  State<PaymentReceivedSortSheet> createState() =>
      _PaymentReceivedSortSheetState();
}

class _PaymentReceivedSortSheetState extends State<PaymentReceivedSortSheet> {
  late PaymentReceivedSortField _field;
