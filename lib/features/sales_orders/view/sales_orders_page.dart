...
import 'package:custom_books/features/sales_orders/view/add_sales_order_page.dart';
...
class _SalesOrdersPageState extends State<SalesOrdersPage> {
  ...
  Widget _statusChip(SalesOrderStatus status) {
    final color = switch (status) {
      SalesOrderStatus.draft => Colors.grey,
