...
class DeliveryChallanSortSheet extends StatefulWidget {
  ...
  @override
  State<DeliveryChallanSortSheet> createState() =>
      _DeliveryChallanSortSheetState();
}

class _DeliveryChallanSortSheetState extends State<DeliveryChallanSortSheet> {
  late DeliveryChallanSortField _field;
  ...
  void _selectField(DeliveryChallanSortField field) {
    setState(() {
      if (_field == field) {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: Dimensions.width20),
            child: Column(
              children: DeliveryChallanSortField.values.map((field) {
            ...
            child: SizedBox(
              ...
              child: OutlinedButton(
                onPressed: () {
                  Navigator.pop(
                    context,
                    SortSheetResult(field: _field, direction: _direction),
                  );
                },
...
class SortSheetResult {
  final DeliveryChallanSortField field;
  final SortDirection direction;

  const SortSheetResult({required this.field, required this.direction});
}
