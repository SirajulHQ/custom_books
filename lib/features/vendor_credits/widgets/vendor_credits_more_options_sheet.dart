...
class VendorCreditsMoreOptionsSheet extends StatelessWidget {
  final VoidCallback onExport;
  final VoidCallback onRefresh;
  final VoidCallback onClose;

  const VendorCreditsMoreOptionsSheet({
    super.key,
  ...
  static void show(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => VendorCreditsMoreOptionsSheet(
