...
class VendorCreditSortSheet extends StatelessWidget {
  final VendorCreditSortField selectedField;
  final SortDirection selectedDirection;
  final void Function(VendorCreditSortField field, SortDirection direction)
  onApply;

  const VendorCreditSortSheet({
    super.key,
  ...
  Widget build(BuildContext context) {
    return GenericSortSheet<VendorCreditSortField>(
