...
class InventoryAdjustmentsMoreOptionsSheet extends StatelessWidget {
  final VoidCallback onExport;
  final VoidCallback onPrint;
  final VoidCallback onRefresh;
  final VoidCallback onClose;

  const InventoryAdjustmentsMoreOptionsSheet({
    super.key,
  ...
  static void show(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => InventoryAdjustmentsMoreOptionsSheet(
